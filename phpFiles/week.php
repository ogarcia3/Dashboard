...
if(isset($_POST['wyear1'])){
    $year1 = ($_POST['wyear1']);
}

if(isset($_POST['wyear2'])){
    $year2 = ($_POST['wyear2']);
}
...
$query = "EXEC [sp_dashboard_week] '$opt','$week1','$week2','$year1','$year2','$brand' ,'$product' ,'$code' ,'$cause' ,'$area' ,'$wc' ,'$shift' ,'$rdc','$order';";
...
if($code == 0){
    $queryPareto = "EXEC [sp_dashboard_week_pareto] '$opt','$week1','$week2','$year1','$year2','$brand' ,'$product' ,'$code' ,'$cause' ,'$area' ,'$wc' ,'$shift' ,'$rdc','$order';";
}else{
    $queryPareto = "EXEC [sp_dashboard_week_pareto_func_own] '$opt','$week1','$week2','$year1','$year2','$brand' ,'$product' ,'$code' ,'$area' ,'$wc' ,'$shift' ,'$rdc','$order';";
}
...
$queryConvert = "EXEC [sp_convert_week_to_period]'$week1','$year1','$week2','$year2';";
...
$queryYtd = "EXEC [sp_dashboard_week_ytd] '$opt','$week1','$week2','$year1','$year2','$brand' ,'$product' ,'$code' ,'$cause' ,'$area' ,'$wc' ,'$shift' ,'$rdc','$order';";
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <table id="productPareto" class="table display" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $queryProducts = "EXEC [sp_dashboard_week_pareto_product]'$opt','$week1','$week2','$year1','$year2','$brand' ,'$product' ,'$code' ,'$cause' ,'$area' ,'$wc' ,'$shift' ,'$rdc','$order';";
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <table  id="example" class="table display" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $query_noti = "EXEC [sp_noti_week] '$opt','$week1','$week2','$year1' ,'$year2','$product','$code','$brand','$order','$area','$wc','$shift','$rdc';";
